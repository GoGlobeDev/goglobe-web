...
export const INVESTORS = [
    {pic: require('img/invester_01.jpg'), intro: 'Litecoin Cash Foundation'},
    {pic: require('img/invester_02.jpg'), intro: 'Deep Brain Chain Foundation'},
    {pic: require('img/invester_03.jpg'), intro: 'Selfsell Foundation'},
    {pic: require('img/invester_04.jpg'), intro: 'Vstar Group'},
    {pic: require('img/invester_05.jpg'), intro: 'Greenfield Capital Group'},
    {pic: require('img/invester_06.jpg'), intro: 'Caribbean Free Trade Association'},
    {pic: require('img/invester_07.jpg'), intro: 'World Blockchain Organization'},
    {pic: require('img/invester_08.jpg'), intro: 'Collin Star Capital'},
    {pic: require('img/invester_09.jpg'), intro: 'Caribbean Institude of Blockchain Industry'},
    {pic: require('img/invester_10.jpg'), intro: 'ALLPKU Management'}
];
